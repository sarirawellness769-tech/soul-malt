      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex space-x-2">
            <button className="text-emerald-700 hover:text-emerald-800 px-4 py-2 rounded-lg border border-emerald-200 hover:bg-emerald-50 transition-colors text-sm font-medium">
              Learn More
            </button>
            <motion.button
